    ...
    <div className="social-icons-wrapper">
      <ul className="social-icons-list">
        <li className="icon-content">
          <a href="https://www.linkedin.com/in/yuanchin/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" data-social="linkedin">
        ...
        <li className="icon-content">
          <a href="https://github.com/yuan-chin" target="_blank" rel="noopener noreferrer" aria-label="GitHub" data-social="github">
            <div className="filled" />
