    ...
    <div className="profile-card-wrapper">
      <div className="card">
        <div className="card-photo">
          <img src="/assets/IMG20240902144805.jpg" alt="Yuan Carlo Chin" className="card-photo-img" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
        </div>
        <div className="card-title">YUAN CARLO CHIN <br />
          <span>Fullstack dev &amp; UX UI</span>
        </div>
        <div className="card-socials">
          <a href="https://github.com/yuan-chin" target="_blank" rel="noopener noreferrer" className="card-socials-btn github">
          ...
          <a href="https://www.linkedin.com/in/yuanchin/" target="_blank" rel="noopener noreferrer" className="card-socials-btn linkedin">
